...
USE_DIRECT_DATA = False  # Set to False to read from CSV file
DATA_FILE = "data.csv"   # Name of CSV file in the same directory

# CSV column mapping (will be auto-detected if not specified)
X_COLUMN = "X"            # Column name for independent variable (e.g., Time)
Y_COLUMN = "Y"            # Column name for dependent variable (e.g., Temperature)
X_ERROR_COLUMN = "X_Error" # Column name for independent variable error
Y_ERROR_COLUMN = "Y_Error" # Column name for dependent variable error
...
FORMULA = "-x * log(y / 100)"  # Formula to calculate results
