...
# Formel mit SymPy-Funktionen definieren sp,sin()
formel =  P1 + P2
...
P1 =  np.array([23, 23, 23, 23, 23, 23, 23, 23])
...
error_P1 =  [0.05] * anzahl_messungen
error_P2 =  1
...
messwerte = [
    [P1[i], P2, T_1] for i in range(anzahl_messungen) 
]
# Fehler für jede Variable
fehler = [
    [error_P1, error_P2 ,error_T_1] for i in range(anzahl_messungen)
]
