...
# Messwerte 
g = np.array([1.220, 1.221, 1.223, 1.220, 1.222, 1.222])  # Messwerte für g in Meter
b = np.array([180, 179, 177, 180, 178, 178]) * 10**-3  # Messwerte für b in Meter (von mm in Meter umgerechnet)
...
error_g = 0.005 #Absoluter Fehler von 0.4 Sekunden
error_b = 0.005 # Absoluter Fehler von 0.5 mm
...
variablen_werte = {
    'Bildweite b (m)': b,
    'Gegenstandsweite g (m)': g,
    'Fehler Bildweite': error_b,
    'Fehler Gegenstandweite': error_g
}
...
messwerte = [
    [g, b] for i in range(anzahl_messungen) 
]
# Fehler für jede Variable
fehler = [
    [error_b, error_g] for i in range(anzahl_messungen)
]
