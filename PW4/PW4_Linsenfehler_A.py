...
ergebnis_name = 'Linsenfehler Konvexenlinse'  # Name des Ergebnisses
...
g = [0.202, 0.175]  # Gegenstandweite der Linse in cm
b = [0.698, 0.725]  # Bildweite der Linse in cm

fehler_b = [0.005] * anzahl_messungen  # Absoluter Fehler von 0.005 Meter
fehler_g = [0.005] * anzahl_messungen  # Absoluter Fehler von 0.005 Meter
...
messwerte = [
    [g[i], b[i]] for i in range(anzahl_messungen)  ## Achtung Reihenfolge wie in der Formel
]
## Achtung Reihenfolge beachten ##
fehler = [
    [fehler_g[i], fehler_b[i]] for i in range(anzahl_messungen)
]
