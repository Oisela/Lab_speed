...
DATA_FILE =  "example_data.csv"   # Name of CSV file in the same directory
DATA_FILE2 = "example_data2.csv"  # Name of second CSV file in the same directory if "" not used
DATA_FILE3 = "example_data3.csv"  # Name of second CSV file in the same directory if "" not used
