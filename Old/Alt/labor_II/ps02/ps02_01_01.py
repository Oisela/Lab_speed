...
delta_p = [-590,-560,-500,-480,-440,-400,-360,-300,-240,-190,-120,0]

delta_p_bar = [404,427,482,513,546,593,627,688,745,800,873,947,]

delta_p_2 = [x - 947 for x in delta_p_bar]
...
FIT_FUNCTION = "lambda x, a: A/x"      # Custom fit function (if FIT_TYPE is "custom") as string e.g., "lambda x, a, b: a * x + b"
