...
def generate_fit_curve_data( plot_xdata, plot_fit2, plot_fit2_grad, plot_fit2_start, plot_fit2_end, plot_ydata, linestyle, dotstyle, y_errors=None, initial_guess=None, fit_function=None):
    ...
    if fit_funktion == True and variabeln_fit is 1:
        # Fit-Kurve berechnen
    ...
    elif fit_funktion == True and variabeln_fit is 2:
...
anzahl_messungen = 9  # Kann leicht angepasst werden
...
amplituden = np.array([11.2, 10.8 ,10.2, 9.6, 9, 8.4, 8.2, 7.6, 7.2])
begin_amplitude = 11.6

t = np.array([0.2, 0.4, 0.6, 0.8, 1, 1.2, 1.4, 1.6, 1.8])

T = np.log(amplituden / begin_amplitude)
...
plot_xlabel = r'Zeit in Millisekunden'                 # Beschriftung der x-Achse
plot_ylabel = r'$ln(A(t)/A_0)$'      # Beschriftung der y-Achse
...
if plot_fit2:
    plot_fit2_grad = 1
    plot_fit2_start = 89 # Startpunkt der Fit-Kurve datenpunkte Array
    plot_fit2_end = 812
    plot_fit2_xdata = t
    plot_fit2_ydata = T
